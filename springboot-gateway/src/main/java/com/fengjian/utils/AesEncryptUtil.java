...
//            System.out.println("数据块位数(byte)：" + cipher.getBlockSize());
    ...
    public static void main(String[] args) {
        String test = encryptHex("6217000010084155046", null);
        System.out.println(test);

        System.out.println(decryptHex(test, null));

        System.out.println(decryptHex("498987A6CFD55A02E573A56D4F652D0AD07B5AF39555FE612373ADB2B99D9221", "1111111111111111"));
    }
}
